...
const Estate = ({ info }) => {
  return (
    <div className="card bg-base-100 shadow-xl">
      <figure className="h-[270px] relative">
        <img src={info.image} alt="property" className="rounded-xl" />
        <div className="absolute top-5 right-5 badge badge-accent font-bold justify-end text-base py-4 px-5">For {info.status}</div>
      </figure>
      <div className="card-body">
        <h2 className="card-title font-bold">{info.estate_title}</h2>
