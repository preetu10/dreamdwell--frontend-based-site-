...
const Estates = ({data}) => {
    ...
    return (
        <div>
           ...
           <p className="text-center font-medium text-base text-black mb-12">Explore our curated selection of exquisite properties tailored to meet your lifestyle and preferences.</p>
